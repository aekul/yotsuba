...
public:
	inline Intersection() :
		shape(NULL), t(std::numeric_limits<Float>::infinity()), isTriangle(false) { }
...
public:
	...
	/// For aether
	bool isTriangle;
	Point triangle_v0, triangle_v1, triangle_v2;
	// If not a triangle, use this
	Point sph_center;
	Float sph_radius;
...
public:
	...
	// Only use this for sphere...
	virtual BSphere getSphere() const {
		SAssert(false);
		return BSphere{};
	}
