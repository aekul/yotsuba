...
struct VisualWorkUnit {
	...
	inline VisualWorkUnit(const Point2i &offset, const mitsuba::Vector2i &size, int worker = 0)
...
struct SceneContext {
	...
	mitsuba::ref<Bitmap> framebuffer;
