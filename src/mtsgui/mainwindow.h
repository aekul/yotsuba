...
public:
	...
	inline void workCanceledEvent(const RenderJob *job, const Point2i &offset, const mitsuba::Vector2i &size) {
...
signals:
	...
	void workCanceled(const RenderJob *job, const Point2i &offset, const mitsuba::Vector2i &size);
...
private:
	...
	mitsuba::ref<ConditionVariable> m_cond;
...
private slots:
	...
	void onWorkCanceled(const RenderJob *job, const Point2i &offset, const mitsuba::Vector2i &size);
	void onRefresh();
...
private:
	...
	mitsuba::ref<RenderQueue> m_renderQueue;
	mitsuba::ref<QRenderListener> m_renderListener;
	...
	mitsuba::ref<QConsoleAppender> m_consoleAppender;
