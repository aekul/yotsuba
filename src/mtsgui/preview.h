...
#endif
private:
	mitsuba::ref<Session> m_session;
	mitsuba::ref<Device> m_device, m_parentDevice;
	mitsuba::ref<Renderer> m_renderer, m_parentRenderer;
	mitsuba::ref<VPLShaderManager> m_shaderManager;
	mitsuba::ref<GPUTexture> m_framebuffer;
	mitsuba::ref<GPUProgram> m_accumProgram;
	mitsuba::ref<Random> m_random;
	int m_accumProgramParam_source1;
	int m_accumProgramParam_source2;
	const GPUTexture *m_accumBuffer;
	mitsuba::ref<Mutex> m_mutex;
	mitsuba::ref<ConditionVariable> m_queueCV;
	mitsuba::ref<Timer> m_timer;
	mitsuba::ref<WaitFlag> m_started;
	...
	mitsuba::ref<const AnimatedTransform> m_camTransform;
