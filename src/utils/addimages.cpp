...
public:
	int run(int argc, char **argv) {
		...
		mitsuba::ref<FileStream> aFile   = new FileStream(argv[2], FileStream::EReadOnly);
		mitsuba::ref<FileStream> bFile   = new FileStream(argv[4], FileStream::EReadOnly);
		mitsuba::ref<FileStream> outFile = new FileStream(argv[5], FileStream::ETruncReadWrite);

		mitsuba::ref<Bitmap> aBitmap = new Bitmap(Bitmap::EOpenEXR, aFile);
		mitsuba::ref<Bitmap> bBitmap = new Bitmap(Bitmap::EOpenEXR, bFile);
		...
		mitsuba::ref<Bitmap> outBitmap = new Bitmap(aBitmap->getPixelFormat(),
