...
static bp::list shapekdtree_getShapes(const ShapeKDTree *kdtree) {
	...
	for (size_t i=0; i<shapes.size(); ++i)
		list.append(bp::object(mitsuba::ref<Shape>(const_cast<Shape *>(shapes[i]))));
	return list;
}
...
static mitsuba::ref<Scene> loadScene1(const fs::path &filename) {
	return SceneHandler::loadScene(filename);
}

static mitsuba::ref<Scene> loadScene2(const fs::path &filename, const StringMap &params) {
...
static mitsuba::ref<TriMesh> trimesh_fromBlender(const std::string &name,
...
void export_render() {
	...
	BP_NAMESPACE_CLASS(ShapeKDTree, mitsuba::Object, bp::no_init)
	...
	mitsuba::Sampler *(Scene::*scene_getSampler)(void) = &Scene::getSampler;
	Film *(Scene::*scene_getFilm)(void) = &Scene::getFilm;
	ShapeKDTree *(Scene::*scene_getKDTree)(void) = &Scene::getKDTree;

	BP_NAMESPACE_CLASS(Scene, NetworkedObject, bp::init<>())
	...
	BP_NAMESPACE_CLASS(Sampler, ConfigurableObject, bp::no_init)
		.def("clone", &mitsuba::Sampler::clone, BP_RETURN_VALUE)
		.def("generate", &mitsuba::Sampler::generate)
		.def("advance", &mitsuba::Sampler::advance)
		.def("setSampleIndex", &mitsuba::Sampler::setSampleIndex)
		.def("getSampleIndex", &mitsuba::Sampler::getSampleIndex)
		.def("getSampleCount", &mitsuba::Sampler::getSampleCount)
		.def("getProperties", &mitsuba::Sampler::getProperties, BP_RETURN_VALUE)
		.def("next1D", &mitsuba::Sampler::next1D)
		.def("next2D", &mitsuba::Sampler::next2D, BP_RETURN_VALUE)
		.def("request1DArray", &mitsuba::Sampler::request1DArray)
		.def("request2DArray", &mitsuba::Sampler::request2DArray);
	...
	BP_NAMESPACE_CLASS(RenderJob, Thread, (bp::init<const std::string &, Scene *, RenderQueue *, bp::optional<int, int, int, bool, bool> >()))
	...
	BP_NAMESPACE_CLASS(RenderQueue, mitsuba::Object, bp::init<>())
	...
	BP_NAMESPACE_STRUCT(Intersection, bp::init<>())
	...
	BP_NAMESPACE_STRUCT(TangentSpace, bp::init<>())
	...
	BP_NAMESPACE_STRUCT(PositionSamplingRecord, bp::init<>())
		.def(bp::init<Float>())
	...
	BP_NAMESPACE_STRUCT(DirectionSamplingRecord, bp::init<>())
	...
	BP_NAMESPACE_CLASS(Shape, ConfigurableObject, bp::no_init)
	...
	BP_NAMESPACE_CLASS(TriMesh, Shape, (bp::init<std::string, size_t, size_t, bp::optional<bool, bool, bool, bool, bool> >()))
		.def(bp::init<Stream *, InstanceManager *>())
	...
	BP_NAMESPACE_CLASS(AbstractEmitter, ConfigurableObject, bp::no_init)
	...
	BP_NAMESPACE_CLASS(Emitter, AbstractEmitter, bp::no_init) // incomplete
	...
	mitsuba::Sampler *(Sensor::*sensor_getSampler)(void) = &Sensor::getSampler;

	BP_NAMESPACE_CLASS(Sensor, AbstractEmitter, bp::no_init)
	...
	bool (Film::*film_develop2)(const Point2i &offset, const mitsuba::Vector2i &size,
	...
	BP_NAMESPACE_CLASS(Film, ConfigurableObject, bp::no_init)
	...
	void (ProjectiveCamera::*projectiveCamera_setWorldTransform1)(const mitsuba::Transform &) = &ProjectiveCamera::setWorldTransform;
	void (ProjectiveCamera::*projectiveCamera_setWorldTransform2)(AnimatedTransform *) = &ProjectiveCamera::setWorldTransform;
	const mitsuba::Transform (ProjectiveCamera::*projectiveCamera_getWorldTransform1)(Float t) const = &ProjectiveCamera::getWorldTransform;
	...
	BP_NAMESPACE_CLASS(ProjectiveCamera, Sensor, bp::no_init)
	...
	BP_NAMESPACE_CLASS(PerspectiveCamera, ProjectiveCamera, bp::no_init)
	...
	BP_NAMESPACE_CLASS(Integrator, ConfigurableObject, bp::no_init)
	...
	BP_NAMESPACE_STRUCT(BSDFSamplingRecord, (bp::init<const Intersection &, mitsuba::Sampler *, ETransportMode>()))
	...
	BP_NAMESPACE_CLASS(BSDF, ConfigurableObject, bp::no_init)
	...
	BP_NAMESPACE_CLASS(Texture, ConfigurableObject, bp::no_init)
	...
	BP_NAMESPACE_CLASS(ImageBlock, WorkResult, (bp::init<Bitmap::EPixelFormat, const mitsuba::Vector2i &, bp::optional<const ReconstructionFilter *, int, bool> >()))
	...
	BP_NAMESPACE_CLASS(RectangularWorkUnit, WorkUnit, bp::init<>())
	...
	bp::class_<RenderListener, mitsuba::ref<RenderListenerWrapper>, boost::noncopyable>
			RenderListener_class("RenderListener", bp::init<>());
	bp::register_ptr_to_python<RenderListener*>();
	bp::implicitly_convertible<mitsuba::ref<RenderListenerWrapper>, mitsuba::ref<RenderListener> >();
