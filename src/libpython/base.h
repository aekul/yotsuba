...
#define BP_NAMESPACE_STRUCT_DECL(Name, Init) \
	bp::class_<mitsuba::Name> Name ##_struct(#Name, Init); \
	bp::register_ptr_to_python<mitsuba::Name*>();

#define BP_STRUCT(Name, Init) \
	BP_STRUCT_DECL(Name, Init) \
	Name ##_struct

#define BP_NAMESPACE_STRUCT(Name, Init) \
	BP_NAMESPACE_STRUCT_DECL(Name, Init) \
	Name ##_struct
...
#define BP_CLASS_DECL(Name, Base, Init) \
	bp::class_<Name, mitsuba::ref<Name>, bp::bases<Base>, boost::noncopyable> Name ##_class(#Name, Init); \
	bp::register_ptr_to_python<Name*>();

#define BP_NAMESPACE_CLASS_DECL(Name, Base, Init) \
	bp::class_<mitsuba::Name, mitsuba::ref<mitsuba::Name>, bp::bases<Base>, boost::noncopyable> Name ##_class(#Name, Init); \
	bp::register_ptr_to_python<mitsuba::Name*>();
...
#define BP_NAMESPACE_CLASS(Name, Base, Init) \
	BP_NAMESPACE_CLASS_DECL(Name, Base, Init) \
	Name ##_class

#define BP_WRAPPED_CLASS(Name, Wrapper, Base, Init) \
	bp::class_<Name, mitsuba::ref<Wrapper>, bp::bases<Base>, boost::noncopyable> Name ##_class(#Name, Init); \
	bp::register_ptr_to_python<Name*>(); \
	bp::implicitly_convertible<mitsuba::ref<Wrapper>, mitsuba::ref<Name> >(); \
	Name ##_class

#define BP_IMPLEMENT_VECTOR_OPS(Name, Scalar, Size) \
	Name ##_struct \
		.def(bp::init<Stream *>()) \
		.def(bp::init<mitsuba::Name>()) \
		.def(bp::self != bp::self) \
		.def(bp::self == bp::self) \
		.def(-bp::self) \
		.def(bp::self + bp::self) \
		...
		.def(bp::self / Scalar()) \
		.def(bp::self /= Scalar()) \
		.def("serialize", &mitsuba::Name::serialize) \
		.def("isZero", &mitsuba::Name::isZero) \
		.def("length", &mitsuba::Name::length) \
		.def("lengthSquared", &mitsuba::Name::lengthSquared) \
		.def("__repr__", &mitsuba::Name::toString) \
		.def("__len__", &FixedSizeSupport<mitsuba::Name, Scalar, Size>::len) \
		.def("__getitem__", &FixedSizeSupport<mitsuba::Name, Scalar, Size>::get) \
		.def("__setitem__", &FixedSizeSupport<mitsuba::Name, Scalar, Size>::set)
...
#define BP_IMPLEMENT_POINT_OPS(Name, Scalar, Size) \
	Name ##_struct \
		...
		.def(Scalar() * bp::self) \
		.def(-bp::self) \
		.def(bp::self + mitsuba::Name::VectorType()) \
		.def(bp::self += mitsuba::Name::VectorType()) \
		.def(bp::self - mitsuba::Name::VectorType()) \
		.def(bp::self -= mitsuba::Name::VectorType()) \
		.def(bp::self - bp::self) \
